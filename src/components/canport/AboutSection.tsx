...
export const AboutSection: React.FC = () => {
  return (
    <section id="a-propos" className="py-20 md:py-28 bg-[#FDFBF7] border-t border-[#EAE3D8] scroll-mt-20">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          >
            ...
            {/* Mantra block */}
            <div className="p-6 rounded-3xl bg-[#F7F3EB]/90 border border-[#E8DFC8] border-l-4 border-l-[#A87C51] shadow-2xs hover:shadow-md transition-shadow">
          ...
          >
            ...
            {coreValues.map((val, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="p-5 sm:p-6 rounded-3xl bg-[#FAF7F2] border border-[#E8E1D5] hover:border-[#D5C7B7] hover:bg-white transition-all shadow-2xs hover:shadow-xl cursor-default"
                >
                  ...
                  <p className="text-xs sm:text-sm text-[#635345] leading-relaxed pl-12">
                    {val.description}
                  </p>
                </motion.div>
              );
            ...
            <motion.div
              whileHover={{ scale: 1.015, y: -2 }}
              transition={{ duration: 0.2 }}
              className="p-6 rounded-3xl bg-white border border-[#E8E1D5] hover:border-[#D5C7B7] shadow-2xs hover:shadow-xl transition-all mt-6 cursor-default"
            >
